app.controller('eventController', ['$scope','$location','userFactory', 'eventFactory', function($scope, $location, userFactory, eventFactory){
$scope.currentUser = {};
$scope.eventErr = "";
...
$scope.createEvent = function(event, isValid){
	if(isValid) {
